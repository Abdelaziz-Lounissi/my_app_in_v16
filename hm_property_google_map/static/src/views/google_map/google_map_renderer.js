...
import { GoogleMapSidebarPropertyAvatar } from './google_map_sidebar';

export class GoogleMapRendererPropertyAvatar extends GoogleMapRenderer {
    /**
     * Override
     * @param {*} record
     * @param {*} isMulti
...
GoogleMapRendererPropertyAvatar.components = {
