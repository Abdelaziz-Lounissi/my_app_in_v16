...
import { GoogleMapSidebarPropertyAvatar } from '@hm_property_google_map/views/google_map/google_map_sidebar';


export class GoogleMapPlacesPropertyAvatarRenderer extends GoogleMapPlacesRenderer {
    /**
     * Override
     * @param {*} record
     * @param {*} isMulti
    ...
    getMarkerContent(record, isMulti) {
        ...
        const content = renderToString('hm_property_google_map.MarkerInfoWindow', {
...
GoogleMapPlacesPropertyAvatarRenderer.components = {
    ...GoogleMapPlacesRenderer.components,
    Sidebar: GoogleMapSidebarPropertyAvatar,
}